...
Робота з теками сейфа через ~VaultClient::folders()~ (див. [[file:main-client.org][~main-client.org~]] і
[[root:spcfctn/code/bitwarden-rust-sdk.md][bitwarden-rust-sdk.md]]). Чотири дії одним інструментом — теки не мають чутливого поля на кшталт
пароля, тож немає причини розділяти права читання й запису так, як для елементів сейфа.
